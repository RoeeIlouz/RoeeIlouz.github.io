...
4. **Interactive Tab Router & Filters**: Fast tab switching (`#about`, `#skills`, `#projects`, `#homelab`, `#contact`) and category-based project filtering with smooth CSS animations.
