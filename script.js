...
const translations = {
  en: {
    ...
    experience: {
      ...
      'exp2-title': 'C2 Systems & Computing Lead (Platoon Sergeant)',
      ...
      'edu1-title': 'Electrical Engineering B.Sc Student',
    ...
    homelab: {
      ...
      'hl-banner-desc': 'High-performance ARM64 SOC running <b>Debian GNU/Linux 13 (Trixie)</b>, orchestrating 30+ containerized microservices across media, telemetry, AI, and Zero Trust networking.',
      ...
      'hl-hw-os-val': 'Debian 13 (Raspberry Pi OS Lite)',
    ...
    contact: {
      ...
      'contact-intro': 'You can contact me from here:',
  ...
  he: {
    ...
    nav: {
      ...
      'nav-homelab': 'מעבדה ביתית (HOMELAB)',
      'nav-contact': 'צור קשר'
    },
    about: {
      ...
      'feat-title': 'ROCIs Tasks',
      'feat-desc': 'אפליקציית ניהול משימות ופרודוקטיביות חכמה: צ\'קליסטים, צירוף קבצים, הזנת משימות בשפה טבעית, סנכרון Offline מלא ואינטגרציה חלקה ל-Google Calendar.',
      'heading-doing': 'מה אני עושה',
      'svc-mobile-title': 'פיתוח אפליקציות ומובייל',
      'svc-mobile-desc': 'פיתוח אפליקציות Flutter & Dart חוצות-פלטפורמות (Android & iOS), עיצוב ממשקי משתמש מודרניים, ניהול State מתקדם.',
      'svc-ee-title': 'סטודנט להנדסת חשמל',
    ...
    experience: {
      ...
      'exp1-desc': 'פיקוד וניהול על מחלקת מחשוב ותקשוב המונה כ-10 אנשי צוות, מתן מענה לתקלות מחשוב, שרתים ותשתיות קריטיות בזמן חירום ופעילות מבצעית אינטנסיבית. אחריות על הקמת חמ״לים ותשתיות תקשורת ומחשוב בשטח, והובלת פתרונות טכנולוגיים מורכבים.',
      'exp2-title': 'אחראי מערכות שליטה ובקרה (וסמל מחלקה)',
      ...
      'edu1-title': 'סטודנט לתואר ראשון בהנדסת חשמל (B.Sc.)',
      'edu1-meta': 'סטודנט לתואר ראשון • מכללת אפקה להנדסה ומדעים',
    ...
    homelab: {
      ...
      'hl-banner-badge': 'שרת ביתי הפועל 24/7',
      'hl-banner-title': 'שרת ביתי Raspberry Pi 5',
      'hl-banner-desc': 'SOC ARM64 בעל ביצועים גבוהים המריץ <b>Debian GNU/Linux 13 (Trixie)</b>, ומנהל מעל 30 שירותי מיקרו-קונטיינרים בתחומי ענן אישי, ניטור, AI ורשתות Zero Trust.',
      ...
      'hl-hw-os-val': 'Debian 13 (Raspbbery Pi OS Lite)',
      ...
      'hl-sec-cf-title': 'Tunnels Cloudflare ו-NPM',
      ...
      'hl-sec-twin-title': 'רשת Twingate וגישה באמצעות VPN',
    ...
    contact: {
      ...
      'contact-intro': 'במידה ותרצו ליצור קשר:',
